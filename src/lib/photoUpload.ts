...
// A função checkStorageHealth foi removida pois causava mais problemas de timeout
// do que resolvia. A validação agora é feita implicitamente no momento do upload. 